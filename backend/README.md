...
## Project Structure
    ...
    ├── testapiautocatalog_117343  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_117343`
...
2. Clone this repo and `cd testapiautocatalog_117343`
